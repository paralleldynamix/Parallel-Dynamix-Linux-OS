...
[![build-ublue](https://github.com/paralleldynamix/Parallel-Dynamix-Linux-OS/actions/workflows/build.yml/badge.svg)](https://github.com/paralleldynamix/Parallel-Dynamix-Linux-OS/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `paralleldynamix/Parallel-Dynamix-Linux-OS` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/paralleldynamix/Parallel-Dynamix-Linux-OS:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/paralleldynamix/Parallel-Dynamix-Linux-OS:latest
  ```
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/paralleldynamix/Parallel-Dynamix-Linux-OS:20230403
```
